---
name: session-sync
description: Synchronizes active Antigravity CLI conversation sessions. Use when restoring or syncing conversation sessions across machines using a shared Git remote.
---
